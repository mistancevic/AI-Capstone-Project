...
| **Full sleep & recovery agent** — late meal ↔ sleep ↔ tomorrow's training reasoning | Discovery step-0 orchestrator vision; trimmed by Moe to a conditional one-line note | Core loop solid in production, and evidence that clients act on the note |
