...
**Key question(s):** Who is the specific user this agent helps?
...
### 10. Activity: Project choice | Theme: Workflow | Topic: Recurring workflow

**Key question(s):** What recurring workflow are you improving? Write the current workflow in plain text.
...
### 11. Activity: Project choice | Theme: Trigger | Topic: Workflow trigger

**Key question(s):** What event starts the workflow?
...
### 12. Activity: Current state | Theme: Process | Topic: Current process steps

**Key question(s):** List the current process as numbered text steps. Do not link to a process map.
...
### 13. Activity: Problem | Theme: Pain points | Topic: Where it breaks

**Key question(s):** Where does the workflow slow down, fail, create rework, or frustrate the user?
...
### 14. Activity: Opportunity | Theme: Agent opportunity | Topic: Why an agent

**Key question(s):** What should the agent help with, and why is an agent a better fit than a static AI feature?
...
### 15. Activity: Data | Theme: Synthetic data plan | Topic: Safe fake data

**Key question(s):** What synthetic data, policies, examples, or cases will you create so the project is safe to build and demo?
...
### 16. Activity: Safety | Theme: Human boundary | Topic: Where humans stay in control

**Key question(s):** What is the agent not allowed to do? When must a human approve, edit, reject, or escalate?
...
### 17. Activity: Measurement | Theme: Success metric | Topic: How you know it works

**Key question(s):** What is one practical metric that would show the agent is useful?
...
### 18. Activity: Demo | Theme: Initial demo idea | Topic: What people will see

**Key question(s):** What will the demo visibly show from input to agent work to human review?
